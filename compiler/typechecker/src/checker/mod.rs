...
pub struct TypeChecker<'a> {
    ...
    pub class_static_members: HashMap<Symbol, HashMap<Symbol, TypeId>>,
    pub class_mutables: HashMap<Symbol, HashMap<Symbol, bool>>,
    pub class_static_mutables: HashMap<Symbol, HashMap<Symbol, bool>>,
    ...
    pub extensions: HashMap<Symbol, HashMap<Symbol, TypeId>>,
...
impl<'a> TypeChecker<'a> {
    ...
    pub fn new(
        ...
        Self {
            ...
            class_static_mutables: HashMap::new(),
