...
use diagnostics::{DiagnosticBuilder, DiagnosticCode, Severity, SourceMap, print_diagnostics};
use linker::Linker;
    ...
    match &cli.command {
        ...
        Commands::Upgrade => {
            ...
            match status {
                ...
                _ => {
                    print_global_error(
                        "Failed to upgrade Pace. Please check your internet connection or try reinstalling manually.",
                    );
                    exit(1);
                }
            }
