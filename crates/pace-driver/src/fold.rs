            ...
            Expr::Binary { left, op, right } => {
                ...
                if let (Expr::IntLiteral(l), Expr::IntLiteral(r)) = (&left_expr, &right_expr) {
                    match op {
                        ...
                        _ => Expr::Binary { left: left_id, op, right: right_id },
                    }
                } else if let (Expr::FloatLiteral(l), Expr::FloatLiteral(r)) = (&left_expr, &right_expr) {
                    match op {
                ...
                } else if let (Expr::BoolLiteral(l), Expr::BoolLiteral(r)) = (&left_expr, &right_expr) {
                    match op {
