...
pub fn declare_runtime_functions<M: Module>(
    ...
    funcs.insert(ustr::Ustr::from("__pace_print_int"), print_int_id);
    ...
    funcs.insert(ustr::Ustr::from("__pace_free"), free_id);
    funcs.insert(ustr::Ustr::from("__pace_ptr_store"), ptr_store_id);
    funcs.insert(ustr::Ustr::from("__pace_ptr_store8"), ptr_store8_id);
    funcs.insert(ustr::Ustr::from("__pace_ptr_load"), ptr_load_id);
    funcs.insert(ustr::Ustr::from("__pace_ptr_load8"), ptr_load8_id);
